...
class Tarjeta(models.Model):
    rut =  models.CharField(max_length=17, null=False, blank=False, verbose_name='RUT')
    pri_nom = models.CharField(max_length=30, null=False, blank=False,verbose_name='Primer Nombre')
    seg_nom = models.CharField(max_length=30,  null=False, blank=False,verbose_name='Segundo Nombre')
    pri_ap = models.CharField(max_length=30, null=False, blank=False, verbose_name='Apelldo Paterno')
    seg_ap = models.CharField(max_length=30,  null=False, blank=False,verbose_name='Apellido Materno')
    ...
    tipo_doc = models.CharField(max_length=1, null=False, blank=False, choices=tipo_doc,  verbose_name='Tipo de documento ')
